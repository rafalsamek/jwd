...
public class AnyToDecimalConverter {
    public static void main(String[] args) {
        ...
        do {
            ...
            int decimal;
            try {
                decimal = AnyToDecimalConverter.convertNumber(number, numberSystem);
    ...
    public static int convertNumber(String any, int numberSystem) throws IllegalStateException {
        if (numberSystem > 36 || numberSystem < 2) {
        ...
        for (int i = 0; i < any.length(); i++) {
            weight--;
            int digit = AnyToDecimalConverter.convertDigit(any.charAt(i), numberSystem);
    ...
    public static int convertDigit(char digit, int numberSystem) {
        int result = switch(digit) {
            case '0' -> 0;
            case '1' -> 1;
            case '2' -> 2;
            case '3' -> 3;
